                ...
                <ul className="space-y-2 font-medium">
                    <li>
                        <Link href="/admin/" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                            <svg className="w-5 h-5 text-gray-500 transition duration-75  text-gray-900 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                    ...
                    <li>
                        ...
                        <Link href="/admin/orders" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                            ...
                            <span className="flex-1 ms-3 whitespace-nowrap">Замовлення</span>
                        </Link>
                    ...
                    <li>
                        <Link href="/admin/users" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                            ...
                            <span className="flex-1 ms-3 whitespace-nowrap">Користувачі</span>
                        </Link>

                    </li>
                    <li>

                        <Link href="/admin/products" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                            ...
                            <span className="flex-1 ms-3 whitespace-nowrap">Товари</span>
                        </Link>
                    </li>
                    <li>
                        <Link href="/" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                            ...
                            <span className="flex-1 ms-3 whitespace-nowrap">Сайт</span>
                        </Link>
